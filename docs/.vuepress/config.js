...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/logo.png' }], //favicons，资源放在public文件夹
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'STDSuperman/docs', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: '陌小路', // 必需
      link: 'https://github.com/STDSuperman' // 可选的
    },
    blogger: { // 博主信息，显示在首页侧边栏
      avatar: 'https://p.qqan.com/up/2019-9/15693062144024091.jpg',
      name: '陌小路',
      slogan: '前端切图仔'
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:2750556766@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/STDSuperman'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=715216293'
        }
      ]
    },
    footer: { // 页脚信息
